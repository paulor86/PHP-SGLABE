<!--
	Atualizando Classe Solicitações - Frank
-->
<?php
...
-->
	<div class="col-md-8 col-md-offset-1 col-xs-12 principal">
					...
					<div class="col-md-7">
						<form method="post" action="<?php echo base_url('/Solicitacoes/software');?>" class="form-group">							
							<textarea name="descricao" required="" class="form-control input-lg" placeholder="Descrição do Software"></textarea><br>
					...
					<div class="col-md-4">
					    <div class="list-group" id="list-tab" role="tablist">
					      <a class="list-group-item list-group-item-action text-center active" id="list-home-list" data-toggle="list" href="<?php echo base_url('/Visualizar/solicitar_software');?>" role="tab" aria-controls="home"><span class="glyphicon glyphicon-th-list"></span> Listar</a>					      
					    </div>
  					</div>				
			</div>			
		</div>

    ...
    <div class="col-md-8 col-md-offset-1 col-xs-12 principal">
	 	<?php if(isset($alertas)){echo $alertas;}?>
			<div class="col-md-12"><h3 class="localTitle"><?php echo $pageTitle;?></h3></div>
				<div class="col-md-7">
					<form method="post" action="<?php echo base_url('/Cadastros/disciplina');?>" class="form-group">
						<div class="col-md-7 no-padding" >
							<textarea name="descricao_disciplina" class="form-control input-lg" placeholder="Descrição da disciplina"></textarea>		
						</div>
						<div class="col-md-4 col-md-offset-1 no-padding" >
							<input type="text" name="codigo_disciplina" class="form-control input-lg"  maxlength="8" placeholder="Código"><br>
						</div>

...
-->
			<div class="col-md-8 col-md-offset-1 col-xs-12 principal">
					...
					<div class="col-md-7">
						<form method="post" action="<?php echo base_url('/Cadastros/maquina');?>" class="form-group">
								<input type="text" name="tombo_maquina" class="form-control input-lg" placeholder="Tombo do computador"><br>
								<textarea name="descricao_maquina" class="form-control input-lg" placeholder="Descrição"></textarea><br>	

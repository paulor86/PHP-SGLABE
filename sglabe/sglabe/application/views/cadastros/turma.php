...
-->
        	<div class="col-md-8 col-md-offset-1 col-xs-12 principal">
					...
					<div class="col-md-7">
						<form method="post" action="<?php echo base_url('/Cadastros/turma');?>" class="form-group">					
							<input type="text" required="" name="codigo_turma" class="form-control input-lg" placeholder="Código da Turma"><br>
									...
									<select name="fk_codigo_curso" required="" class="form-control  input-lg">
										...
										<?php 
											foreach ($dataCursos as $key) {
												echo "<option value=\"{$key->codigo_curso}\">{$key->descricao}</option>";
											}
										?>
									</select>
						...
						<div class="col-md-4 col-md-offset-1 no-padding">
							<input type="number" required="" name="periodo"  class="form-control input-lg" placeholder="Período">
						</div>	

...
-->
			<div class="col-md-8 col-md-offset-1 col-xs-12 principal">						
					...
					<div class="col-md-7">
						<form method="post" name="form_usuario" action="<?php echo base_url("/Editar/usuario_aluno/$tmpCodUsuario");?>" class="form-group">
							...
							<input type="text" name="matricula"  value="<?php echo $matricula;?>" class="form-control input-lg" placeholder="Matricula"><br>
							<input type="text" name="cpf" onblur="ValidarCPF(form_usuario.cpf);" onkeypress="MascaraCPF(form_usuario.cpf);" value="<?php echo $cpf;?>" class="form-control input-lg" placeholder="CPF: 123.456.789-00"><br>
							<input type="email" name="email"  value="<?php echo $email;?>"  class="form-control input-lg" placeholder="E-mail"><br>
							<input type="text" name="telefone"  value="<?php echo $telefone;?>"  class="form-control input-lg" placeholder="Telefone: 92 9 9123-4567"><br>

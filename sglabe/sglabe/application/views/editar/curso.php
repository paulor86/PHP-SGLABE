...
-->
			<div class="col-md-8 col-md-offset-1 col-xs-12 principal">
					...
					<div class="col-md-7">
						<form method="post" action="<?php echo base_url("/Editar/curso/$tmpCodCurso");?>" class="form-group">
							<input type="text" required="" value="<?php echo $codigo_curso;?>" name="codigo_curso" class="form-control input-lg" placeholder="Código do Curso"><br>
							<input type="text" required="" value="<?php echo $nome_curso;?>" name="nome_curso" class="form-control input-lg" placeholder="Nome do Curso"><br>					

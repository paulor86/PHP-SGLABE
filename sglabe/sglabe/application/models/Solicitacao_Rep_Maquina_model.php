...
class Solicitacao_Rep_Maquina_model extends CI_Model {
		...
		public function solicitarReparo(){
			...
			$query1 = $this->db->query("INSERT INTO solicitacao(fk_matricula,tipo,data_solicitacao,descricao) 
				VALUES($fk_matricula,'reparo_maquina','$data',?)",$descricao);
